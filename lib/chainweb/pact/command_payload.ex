defmodule Kadena.Chainweb.Pact.CommandPayload do
  ...
  @type valid_pact_value :: raw_value() | list(raw_value())
  @type pact_value :: list(valid_pact_value())
  @type map_return :: map() | nil
  @type valid_extract :: {:ok, string_value()} | {:ok, map_return()} | {:ok, raw_signers()}
  ...
  @spec extract_signers_list(signers :: signers()) :: valid_extract()
